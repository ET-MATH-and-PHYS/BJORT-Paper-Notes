...
\begin{lem}[label=lem:oplusPres]
    Let $F,G,H:\mathcal{B}\to \cat{Ch}(\mathcal{B})$ be functors such that $F\simeq_{\cat{Ch}}G$. Then
    %%
    \begin{equation*}
        F\oplus H\simeq_{\cat{Ch}}F\oplus G
    \end{equation*}
    %%
\end{lem}
\begin{proof}
...
\begin{lem}[label=lem:homotopCancel]
    Let $F,G,H:\mathcal{B}\to \cat{Ch}(\mathcal{B})$ be functors such that $F\oplus H\simeq_{\cat{Ch}}G\oplus H$. Then $F\simeq_{\cat{Ch}}G$.
\end{lem}
\begin{proof}
    \textbf{TBD}
\end{proof}
